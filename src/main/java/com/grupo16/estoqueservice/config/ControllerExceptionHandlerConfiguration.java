package com.grupo16.estoqueservice.config;

import com.grupo16.estoqueservice.exception.ExceptionJson;
import com.grupo16.estoqueservice.exception.SystemBaseException;
...
public class ControllerExceptionHandlerConfiguration {
	...
	private static final String AUTH_EXCEPTION_HANDLER_ERROR_TO_RESOLVE_EXCEPTION = "estoque.exceptionHandler.errorToResolveException";
	private static final String AUTH_ARGUMENT_NOT_VALID = "estoque.argumentNotValid";
